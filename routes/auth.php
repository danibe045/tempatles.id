...
// Import kontroler OTP baru kamu di sini
...
Route::middleware('guest')->group(function () {
    ...
    // =========================================================================
    // RUTE BARU: ALUR RESET PASSWORD VIA OTP WHATSAPP KUSTOM
    // =========================================================================
    
    // 1. Halaman Minta OTP (Menggantikan form email lama)
    ...
    // 2. Halaman Input & Verifikasi 6 Digit OTP
    Route::get('verify-otp', [PasswordResetOtpController::class, 'showVerifyForm'])
        ->name('password.otp.verify_form');
        
    Route::post('verify-otp', [PasswordResetOtpController::class, 'verify'])
        ->name('password.otp.submit');

    // 3. Halaman Ganti Password Baru (Hanya bisa diakses jika OTP sukses)
